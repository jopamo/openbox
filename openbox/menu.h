...
typedef void ( *ObMenuExecuteFunc )( struct _ObMenuEntry *entry, struct _ObMenuFrame *frame, struct _ObClient *client,
...
void menu_show( gchar *name, const GravityPoint *pos, gint monitor, gboolean mouse, gboolean user_positioned,
