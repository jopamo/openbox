...
struct _ObClient *focus_fallback( gboolean allow_refocus, gboolean allow_pointer, gboolean allow_omnipresent,
                                  gboolean focus_lost );
...
gboolean focus_valid_target( struct _ObClient *ft, guint desktop, gboolean helper_windows, gboolean iconic_windows,
                             gboolean all_desktops, gboolean nonhilite_windows, gboolean dock_windows,
                             gboolean desktop_windows, gboolean user_request );
