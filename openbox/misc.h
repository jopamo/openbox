...
typedef enum { OB_STATE_STARTING, OB_STATE_RUNNING, OB_STATE_EXITING, OB_STATE_RECONFIGURING } ObState;
...
typedef enum { OB_ORIENTATION_HORZ, OB_ORIENTATION_VERT } ObOrientation;

typedef enum { OB_CORNER_TOPLEFT, OB_CORNER_TOPRIGHT, OB_CORNER_BOTTOMLEFT, OB_CORNER_BOTTOMRIGHT } ObCorner;
